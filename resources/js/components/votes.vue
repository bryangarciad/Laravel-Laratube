<template>
    <div>
        <svg @click="vote('up')" class="thumbs" :class="{ 'thumbs-up-active': upvoted }" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 478.2 478.2" style="enable-background:new 0 0 478.2 478.2;" xml:space="preserve">
            ...
            {{ upvotes_count }}
            <svg @click="vote('down')" class="thumbs" :class="{ 'thumbs-down-active': downvoted }" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
